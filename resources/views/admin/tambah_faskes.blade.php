            ...
            <div class="col-md-4">
                <form action="/fasilitas/tambah" method="POST">
                    ...
                    <div class="mb-2 input-group flex-nowrap">
                        ...
                        <select name="id_jenis_faskes" class="form-select  @error('id_jenis_faskes') is-invalid @enderror"
                    ...
                    <div id="date-picker-example"
                        ...
                        <input placeholder="Select date" type="date" id="pengadaan" name="pengadaan"
                            class="form-control @error('pengadaan') is-invalid @enderror" value="{{ old('pengadaan') }}">
                        @error('pengadaan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
